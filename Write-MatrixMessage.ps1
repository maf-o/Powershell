        ...
        ###################
            ...
            Else{                        
                If($MatrixMessage){                   
                    ...
                    $MatrixMessageCoordinates.keys | get-random | foreach{                        
...
Function New-Rectangle
{
    $(get-command New-Rectangle | select -ExpandProperty Definition)
}
"@
...
Function New-Coordinate
{        
    $(get-command New-Coordinate | select -ExpandProperty Definition)
}
"@
...
Function Get-BufferCell
{
    $(get-command Get-BufferCell | select -ExpandProperty Definition)
}
"@
...
Function New-BufferCell
{
    $(get-command New-BufferCell | select -ExpandProperty Definition)
}
"@
...
Function Set-BufferCell
{
    $(get-command Set-BufferCell | select -ExpandProperty Definition)
}
"@
    ...
    ########################################################################
        ...
        If($MatrixMessage){
            ...
            While($columns.getenumerator() -ne $null){                                
